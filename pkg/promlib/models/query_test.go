...
func TestParse(t *testing.T) {
	...
	t.Run("parsing query from unified alerting", func(t *testing.T) {
		...
		res, err := models.Parse(context.Background(), span, q, "15s", intervalCalculator, true, false)
	...
	t.Run("parsing query model with step", func(t *testing.T) {
		...
		res, err := models.Parse(context.Background(), span, q, "15s", intervalCalculator, false, false)
		require.NoError(t, err)
	...
	t.Run("parsing query model specified scrape-interval in the data source", func(t *testing.T) {
		...
		res, err := models.Parse(context.Background(), span, q, "240s", intervalCalculator, false, false)
		require.NoError(t, err)
...
func TestRateInterval(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			res, err := models.Parse(context.Background(), span, q, tt.args.dsScrapeInterval, intervalCalculator, false, false)
			require.NoError(t, err)
	...
	t.Run("minStep is auto and ds scrape interval 30s and time range 1 hour", func(t *testing.T) {
		...
		res, err := models.Parse(context.Background(), span, query, "30s", intervalCalculator, false, false)
		require.NoError(t, err)
	...
	t.Run("minStep is auto and ds scrape interval 15s and time range 5 minutes", func(t *testing.T) {
		...
		res, err := models.Parse(context.Background(), span, query, "15s", intervalCalculator, false, false)
		require.NoError(t, err)
